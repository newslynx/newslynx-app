...
// Don't use on large objects or ones that contain not serializable data, e.g. date objects
...
// 		list_item.name = prop_name;
// 		return list_item;
// 	}).value();
// }

// function imbueListOptionsWithAccountData(eventSchema){
// 	// We'll load up the article summaries and impact tags
// 	// eventSchema.impact_tags = 
// }
