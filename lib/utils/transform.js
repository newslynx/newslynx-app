...
function populateSousChefsWithDefaultEvent(sousChefs, eventSchema){
	return sousChefs.map(function(sousChef){
		sousChef.default_event = eventSchema;
		return sousChef;
	});
}
...
module.exports = {
	populateSousChefsWithDefaultEvent: populateSousChefsWithDefaultEvent,
