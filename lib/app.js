...
passport.strategies = require('./utils/passport').strategies;
var stylus = require('stylus');
var nib = require('nib');
var environment = require('./settings');
var models = require('./models');
var routes = require('./routes');
var users = require('./routes/organizations');
...
// auth setup
passport.use(passport.strategies.local);
