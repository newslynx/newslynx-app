...
router.get('/exports', function(req, res) {
  ...
  queue()
    .defer(utils.auth.sendToApi(req, res), '/api/_VERSION/events?per_page=100&sous_chefs=-twitter-search-content-item-links-to-event&content_item_ids='+content_item_id)
