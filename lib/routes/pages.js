...
router.get('/approval-river', function(req, res) {
  ...
  queue()
    ...
    // .defer(utils.auth.sendToApi(req, res), '/api/_VERSION/recipes?creates=events&status=-inactive&recipes=-twitter-list-to-event-promotion,-twitter-user-to-event-promotion,-facebook-page-to-event-promotion')
