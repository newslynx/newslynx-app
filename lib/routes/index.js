...
router.get('/settings', function(req, res) {
	...
	queue()
		...
		.defer(sendToApi(req,res), '/api/_VERSION/recipes?sous_chefs=rss-feed-to-contentium')
			.await(function(err, userInformation, orgSettings, tagsObj, recipesList){
				...
				// Add the sous-chefs specified in our query parameters as keys on our `recipes` object
