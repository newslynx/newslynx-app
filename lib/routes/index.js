...
router.get('/articles', function(req, res) {
    ...
    .defer(readFileAsJson, 'lib/public/data/account-data/subject_tags.json')
    .defer(readFileAsJson, 'lib/public/data/account-data/impact_tags.json')
    ...
    .defer(readFileAsJson, 'lib/public/data/event-schemas.json')
			.awaitAll(function(err, results){
				...
				article_summaries = utils.transform.hydrateTagsInfo(article_summaries, info);
