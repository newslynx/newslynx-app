...
router.get('/approval-river', function(req, res) {
	...
	info.page = sanitize(info.title);
	// Fetch data
	async.map(['lib/public/data/recipe-schemas.json', 'lib/public/data/account-recipes.json', 'lib/public/data/approval-river-items.json'], readFileAsJson, function(err, results){
		// Data
