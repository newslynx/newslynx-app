...
router.get('/articles', function(req, res) {
	...
	queue()
		...
		.defer(sendToApi(req, res), '/api/_VERSION/tags?sort=-created') // needs segregation?
		.defer(sendToApi(req, res), '/api/_VERSION/content?sort=-created')
		.defer(readFileAsJson, 'lib/public/data/common-data-models/event-schema.json')
		...
		.defer(readFileAsJson, 'lib/public/data/common-data-models/article-schema.json')
			.await(function(err,    tagCategories, tagLevels, tagAttributeColors, tagsInfo, contentInfo, eventSchema, timezoneSettingInfo, articleSchema){
				logNullResponse(err, [tagCategories, tagLevels, tagAttributeColors, tagsInfo, contentInfo, eventSchema, timezoneSettingInfo, articleSchema]);
				...
				var article_summaries_with_hydrated_tags = utils.transform.hydrateTagsInfo(contentInfo.content_items, tags, ['tag_ids']);
				...
				info.articleSummaries = article_summaries_with_hydrated_tags;
				// Timezone
				info.timezone = timezoneSettingInfo.value;
