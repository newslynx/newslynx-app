...
router.get('/articles', function(req, res) {
	...
	info.page = sanitize(info.title);
	// Fetch data
	async.map(['lib/public/data/account-data/org.json','lib/public/data/article-summaries.json','lib/public/data/article-rows.json','lib/public/data/article-details.json','lib/public/data/event-schemas.json'], readFileAsJson, function(err, results){
		// Data
		info.org = results[0];
