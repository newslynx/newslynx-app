			...
			articleDetail: {
				set: {
					go: function(articleSummaryModel){
						...
						this.articleDetail.set.fetch( uid, destination );
						return this;
					},
					...
					fetch: function(articleUid, cb){
						...
						var loaded_matches = _.filter(articles_detailed, function(obj) { return obj.uid === articleUid });
