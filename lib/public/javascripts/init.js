...
collections.init = {
	articles: function(){
		...
		var timestampSortDesc = makePourOverSort('timestamp'),
				pageviewsSortDesc = makePourOverSort('pageviews'),
				twitterMentionsSortDesc = makePourOverSort('twitter'),
				facebookLikesSortDesc = makePourOverSort('facebook'),
				avgTimeOnPageSortDesc = makePourOverSort('avg_time_on_page'),
				internalSortDesc = makePourOverSort('internal'),
				externalSortDesc = makePourOverSort('external');

		// Create sorts on number of tags, slightly different because it's a computed value
		var subjectTagsSortDesc = makePourOverSortByLength('subject_tags'),
				impactTagsSortDesc = makePourOverSortByLength('impact_tags');
