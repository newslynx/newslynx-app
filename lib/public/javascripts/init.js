...
// 		console.log($('#recipe-templ').html() );
// console.log($('#recipe-schema-list-item-templ').html() );
// console.log($('#recipe-schema-form-templ').html() );
// console.log($('#alert-templ').html() );
...
collections.init = {
	articles: function(){
		...
		// // Article summaries
		// this.article_summaries.instance = new this.alert_summaries.Collection(pageData.articleSummaries);
		// // Article summaries
		// this.active_article_summaries.instance = new this.alert_summaries.Collection([]);
		// // This will populate the grid view based on our selection
		// this.active_comparison_articles.instance = new this.active_comparison_articles.Collection([]);
		// // Article summaries
