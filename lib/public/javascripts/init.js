...
collections.init = {
	...
	"approval-river": function(){
		...
		this.loaded_alerts.instance = new this.loaded_alerts.Collection(pageData.eventsInfo.events);
...
app.init = {
	...
	"approval-river": function(){
		...
		collections.loaded_alerts.main_river_instance.metadata('total_pending', pageData.eventsInfo.total);

		collections.active_alerts.instance.metadata('total_pending', pageData.eventsInfo.total);
		collections.active_alerts.instance.metadata('page_size', pageData.eventsInfo.pagination.per_page);
