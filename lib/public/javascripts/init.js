...
collections.init = {
	...
	"approval-river": function(){
		...
		// TODO, switch this to `event_count.pending` when that gets changed in the api
		var manual_recipe = {id: -1, name: 'Manually created', event_count: pageData.manualEventsTotal, sous_chef: 'manual-event', created: new Date().toString()};
