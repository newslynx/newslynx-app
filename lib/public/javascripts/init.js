...
collections.init = {
	articles: function(){
		...
		collections.article_comparisons.instance.metadata('sort_by', pageData.articleSummariesInfo.sort_by);
		var sort_ascending = !/^-/.test(pageData.articleSummariesInfo.sort_by) // Determine this by seeing if our sort key beings with a hyphen or not. If it has a hyphen we're sorting descending and ascending is thus false
		collections.article_comparisons.instance.metadata('sort_ascending', sort_ascending);
