templates.init = {
	...
	settings: function(){
		...
		this.subject_tagFactory = _.template( $('#subject-tag-templ').html() );
...
collections.init = {
	...
	settings: function(){
		// var existing_rss = 
		// this.article_rss_feeds.instance = new this.article_rss_feeds.Collection(pageData.article_rss_feeds);
