...
app.init = {
	...
	settings: function(){
		...
		this.defaults.staff_twitter_list_to_promotion_recipe_name = 'Staff Twitter List to Promotion';
		this.defaults.twitter_user_to_promotion_recipe_name = 'Twitter User to Promotion';
		this.defaults.facebook_page_to_promotion_recipe_name = 'Facebook Page to Promotion';
