routing = {
	Router: Backbone.Router.extend({
		...
		set: {
			radio: function(uid, trigger){
				...
				routing.router.navigate(models.section_mode.get('mode')+'/' + uid, {trigger: trigger});
			},
	...
	helpers: {
		diffUids: function(mode, newUids){
			...
			console.log('previous uid', previous_uids)
			if (mode == 'my-recipes' && !previous_uids) previous_uids = app.helpers.drawer.getAllUids.call(app.instance);
