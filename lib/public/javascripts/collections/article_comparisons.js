collections.article_comparisons = {
	...
	"Collection": Backbone.Collection.extend({
		...
		operation: 'mean', // Set our default options, these all correpond to keys in the article comparisons object. Essentially, what values should we pluck out of that to use as our comparison point
		group: 'all',
		max: 'per_975'
