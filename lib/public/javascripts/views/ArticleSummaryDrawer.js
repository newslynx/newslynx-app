views.ArticleSummaryDrawer = Backbone.View.extend({
	...
	updateSelected: function(){
		...
		// console.log('updateselected', mode)
	...
	setActiveCssState: function(){
		...
		// console.log('persisting...', po_model)
		// console.log('active_selected',active_selected)
		// console.log('selected_for_compare',selected_for_compare)
		// console.log('selected_for_detail',selected_for_detail)
		return this;
	},
