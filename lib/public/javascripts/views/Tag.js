views.Tag = views.AA_BaseTag.extend({
	...
	getCount: function(){
		...
		var key = crossover[group].key,
				facet_key = crossover[group].facet_key,
				model_key = crossover[group].model_key;

		var facet = models.tag_facets.get(facet_key);
