views.ArticleDetail = Backbone.View.extend({
	...
	initialize: function(){
		...
		// Spotted tail does some mutation on this so let's give it its own business
		this.eventsDataForST = _.map(events_data, function(eventData){ return $.extend(true, {}, eventData); });
