views.ArticleComparisonGrid = Backbone.View.extend({
	...
	render: function(){
		var select_dimensions = _.extend({selects: this.collection.metadata('selects'), sorted_by: models.content_item_filters.metadata('sort')}, helpers.templates.metrics);
		var grid_markup = templates.articleGridContainerMarkupFactory(select_dimensions);
