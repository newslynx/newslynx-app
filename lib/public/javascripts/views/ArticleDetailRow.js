views.ArticleDetailRow = Backbone.View.extend({
	...
	render: function() {
		var $el = this.$el,
				...
				article_detail_markup = templates.articleDetailRowFactory( _.extend(model_json, helpers.templates) );
	...
	update: function(cb){
		...
		row.append('div')
				...
				.html(function(d) { return helpers.templates.conciseDate(d.datetime) });
