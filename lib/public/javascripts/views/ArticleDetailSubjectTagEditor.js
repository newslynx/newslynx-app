views.ArticleDetailSubjectTagEditor = views.AA_BaseTag.extend({
	...
	syncToApi: function(model, checked){
		...
		// if (checked){
			...
			// collections.article_detailed_subject_tags.instance.sync('create', model);
			// // Sort by name
		...
		// } else {
			collections.article_detailed_subject_tags.instance.sync(method, model);
		...
		// }
		// collections.article_detailed_subject_tags.instance.sync();
	}
