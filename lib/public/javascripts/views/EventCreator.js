views.EventCreator = Backbone.View.extend({
	...
	initialize: function(options){
		...
		var event_creator_schema = _.map(pageData.eventCreatorSchema, function(schema) { return _.clone(schema) })
		...
		var event_creator_options = _.map(event_creator_schema, function(schema) { return _.clone(schema) });
