views.EventCreator = Backbone.View.extend({
	...
	initialize: function(options){
		...
		var event_creator_schema = _.map(pageData.eventCreatorSchema, function(schema) { return $.extend(true, {}, schema); })
		...
		var event_creator_options = _.map(event_creator_schema, function(schema) { return $.extend(true, {}, schema) });
		// event_creator_schema.slice();
