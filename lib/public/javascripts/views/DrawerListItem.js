views.DrawerListItem = Backbone.View.extend({
	...
	// updateViewingRadio: function(thisModel){
	// 	var competitor_active = models.drawer_item_all.instance.get('viewing');
	// 	console.log('here')
	// 	// console.log(competitor_active)
	// 	// thisModel.set('viewing', !competitor_active);
	// },
