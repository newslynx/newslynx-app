views.RecipeSchemaForm = Backbone.View.extend({
	...
	// printSubmitMsgColorfully: function(error, msg){
	...
	// 		this.$el.css('background-color', '#D0F1D1').animate({'background-color': '#fff'}, animation_duration, function(){
	// 			that._time_picker.destroy();
	// 			// that.killAllSubviews();
	// 			that.render();
	// 		});
	// 	} else {
