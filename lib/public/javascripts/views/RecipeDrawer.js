views.RecipeDrawer = Backbone.View.extend({
	...
	initialize: function(){
		...
		this.model.set('set_default_event', false);
	...
	saveModal: function(e){
		e.preventDefault();
		var that = this;
		var set_default_event = this.model.get('set_default_event') || false;
		...
		model_data.options = recipe_data;
			...
			if (!error){
				this_right_here.model.save(model_data, {
					error: function(model, response, options){
						...
						that.printMsgOnSubmit(true, 'Could not save to the server. Copy and paste your console (right-click, Inspect Element): <a href="mailto:meow@newslynx.org">meow@newslynx.org</a> &mdash; <em>Merlynne</em>.');
					},
