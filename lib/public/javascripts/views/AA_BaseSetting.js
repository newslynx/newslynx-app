views.AA_BaseSetting = Backbone.View.extend({
	...
	saveModel: function(e){
		...
		// TEMPORARY, TODO, the api is saving these attributes so get rid of them for now
		this.model.unset('viewing', {silent: true});
		this.model.unset('enabled', {silent: true});
		this.model.unset('input_val', {silent: true});
		this.model.unset('data_changed', {silent: true});
