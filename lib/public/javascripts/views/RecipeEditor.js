views.RecipeEditor = views.AA_BaseForm.extend({
	...
	initialize: function(opts){
		...
		var sous_chef_model = $.extend(true, {}, collections.sous_chefs.instance.findWhere({slug: opts.model.sous_chef}) ),
				sous_chef_schema = sous_chef_model.get('options'),
				default_event_schema = sous_chef_model.get('default_event');
