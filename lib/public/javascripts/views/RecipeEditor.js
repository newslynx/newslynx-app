views.RecipeEditor = views.AA_BaseForm.extend({
	...
	initialize: function(opts){
		var recipe_settings = opts.model.options,
				default_event_settings = opts.model.default_event || {};


		var sous_chef_schema = $.extend(true, {}, collections.sous_chefs.instance.findWhere({slug: opts.model.sous_chef}).get('options') );

		// Add the name manually
		sous_chef_schema.name.selected = opts.model.name;
		console.log('recipe_settings', recipe_settings)
		console.log('sous_chef', sous_chef_schema)
