views.AA_BaseForm = Backbone.View.extend({
	...
	formJsonToMarkup: {
		...
		datepicker: function(fieldName, data, isDefaultEvent){
			...
			var input_markup = '<input type="text" data-type="datepicker" class="'+class_name+'" placeholder="'+((data.help && data.help.placeholder) ? this.escapeQuotes(data.help.placeholder) : '') +'" autocomplete="off" data-is-default-event="'+isDefaultEvent+'" data-serialize-skip="true"/>';
