...
helpers.common = {
    ...
    drawer: {
        filter: function(tagModel, isActive) {
            ...
            return console.log(isActive, filter, query_value), isActive ? collections.po.article_summaries.filters[filter].intersectQuery(query_value) : collections.po.article_summaries.filters[filter].removeSingleQuery(query_value), 
