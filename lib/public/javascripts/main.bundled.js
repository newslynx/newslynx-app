...
helpers.common = {
    ...
    bakeRecipeUpdateForm: function(uid, source, settings) {
        ...
        })[0].schema), console.log("source", source), console.log("settings", settings), 
        schema_with_selects = this.combineFormSchemaWithVals(schema, settings), markup = this.bakeForm(source, schema_with_selects);
    },
