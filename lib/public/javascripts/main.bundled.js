...
helpers.common = {
    ...
    river: {
        ...
        loadAllAlerts: function(loadAllModel) {
            ...
            load_all && (section_mode = models.section_mode.get("mode"), collections.detail_items.instance.add(this[section_mode].detailData));
        },
    ...
    drawer: {
        ...
        enableAll: function() {
            models.drawer_item_all.instance.set("viewing", !0);
        }
    },
    itemDetail: {
