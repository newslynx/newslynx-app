...
helpers.common = {
    ...
    updateViewAll: function() {
        ...
        viewing_all ? (models.all_alerts.instance.set("viewing", !0), active_drawer_items = collections.drawer_items.instance.getTrue("viewing"), 
        active_drawer_items.length && collections.drawer_items.instance.getTrue("viewing")[0].set("viewing", !1)) : models.all_alerts.instance.set("viewing", !1);
    },
    bake: function() {
    ...
    river: {
        bake: function(detailModel) {
            ...
            return detailModel.set("destroy", !1), item_view = new views.RiverItem({
                model: detailModel
        ...
        loadAllAlerts: function(loadAllModel) {
            ...
            collections.detail_items.instance.set(collections.all_alerts.instance.models), app.helpers.isotope.relayout(), 
            collections.detail_items.instance.each(function(model) {
                console.log(model);
            }));
        },
    ...
    itemDetail: {
        go: function(listItemModel) {
            var destination, action, is_new = listItemModel.get("viewing"), id = listItemModel.get(this.listId), pending = listItemModel.get("pending"), min_timestamp = collections.all_alerts.instance.meta("timestamp");
        ...
        fetch: function(itemId, action, cb, pending, minTimestamp) {
            var page_limit = 5, mode = models.section_mode.get("mode"), loaded_matches = collections.all_alerts.instance.filterAlerts(app.instance.detailId, itemId);
    ...
    articles: function() {},
    "approval-river": function() {
        this.recipes.instance = new this.recipes.Collection(pageData.accountRecipes), this.recipes.instance.url = "/api/recipes", 
        this.recipes.instance_static = new this.recipes.Collection(pageData.recipeSchemas), 
        this.alerts.instance = new this.alerts.Collection(), this.alerts.instance.sort = "timestamp", 
        this.all_detail_items.instance = new this.all_detail_items.Collection(pageData.alerts.results), 
        this.all_detail_items.instance.meta("timestamp", pageData.alerts.min_timestamp);
    },
    settings: function() {}
}, app.init = {
    articles: function() {
