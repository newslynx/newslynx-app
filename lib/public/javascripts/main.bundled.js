...
helpers.common = {
    ...
    bake: function() {
        return collections.drawer_items.instance.each(function(recipe) {
            ...
            this.$recipes.append(recipe_view.render().el), this.totalAlerts += recipe_view.pending;
    ...
    itemDetail: {
        ...
        fetch: function(itemUid, action, cb) {
            ...
            if (console.log(mode), loaded_matches.length) cb.call(this, loaded_matches); else if ("remove" != action) {
