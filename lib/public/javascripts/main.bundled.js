...
helpers.common = {
    ...
    sectionMode: {
        ...
        compare: function() {
            ...
            console.log(compare_models), compare_models.length || (compare_models = collections.article_summaries.instance.where({
                selected: !0
            })), console.log(compare_models), collections.article_comparisons.instance.set(compare_models, {
                merge: !0
            });
        },
        single: function() {}
    ...
    drawer: {
        ...
        remove: function(summaryModel) {
            summaryModel.set("in_drawer", !1);
        }
    },
    addToComparison: function(e) {
        var $btn = $(e.currentTarget), action = $btn.attr("data-action"), selected_models = collections.article_summaries.instance.where({
            selected: !0
        });
        "replace" == action ? collections.article_comparisons.instance.set(selected_models) : "append" == action && collections.article_comparisons.instance.add(selected_models);
    },
    comparison: {
        add: function(summaryModel) {
            console.log("adding");
        ...
        remove: function(comparisonModel) {
            console.log("removing"), comparisonModel.set("destroy", "delete");
        }
    }
    ...
    render: function() {
        ...
        return console.log(article_detail_markup), this.$el.html(article_detail_markup), 
        this.$el.attr("data-title", model_json.title).attr("data-date", model_json.timestamp), 
