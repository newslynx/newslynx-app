...
helpers.templates = {
    ...
    prettyTimestamp: function(utcDate) {
        console.log(utcDate, new Date(utcDate * 1e3).toLocaleString());
...
app.Articles = Backbone.View.extend({
    ...
    toggleAllDrawer: function(e) {
        var checked = $(e.currentTarget).find("input").prop("checked"), selected_for = "selected_for_" + models.section_mode.get("mode");
    ...
    detail: {
        add: function(detailModel) {
            ...
            var subject_tags_full = detailModel.get("subject_tags_full");
            var impact_tag_categories = detailModel.get("impact_tag_categories");
            var impact_tag_levels = detailModel.get("impact_tag_levels");
...
views.ArticleSummaryDrawer = Backbone.View.extend({
    ...
    setActiveCssState: function() {
        var selected = this.model.get("active_selected") || false, id = this.model.get("id");
