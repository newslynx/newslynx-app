...
views.ArticleDetail = Backbone.View.extend({
	...
	setDownloadButton: function(e){
		...
		csvs[timestamp+'_article_'+this.model.id+'_comparisons'] = flattenObj(models.comparison_metrics.toJSON(), model_json.metrics);
		...
		function flattenObj(comparisonObj, modelMetrics) {
