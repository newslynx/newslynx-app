...
helpers.common = {
    ...
    formJsonToMarkup: {
        text: function(source, fieldName, fieldNamePretty, data) {
            ...
            return markup = '<div class="form-row">', markup += '<label for="' + fieldName + '"> ' + fieldNamePretty + "</label> ", 
        ...
        select: function(source, fieldName, fieldNamePretty, data) {
            var markup;
            return markup = '<div class="form-row">', markup += "<label>" + fieldNamePretty + "</label> ", 
        ...
        checkbox: function(source, fieldName, fieldNamePretty, data) {
            ...
            if (_.contains(banished_keys, fieldNamePretty)) return "";
            var markup;
            return markup = '<div class="form-row">', markup += '<label for="' + fieldName + '">' + fieldNamePretty + "</label> ", 
    ...
    save: function(e) {
        e.preventDefault();
        var recipe_data = this.remodelRecipeJson(), new_recipe_creator_model = new models.recipe_creator.Model();
    ...
    remodelRecipeJson: function() {
        ...
        }, model_json = views.helpers.remodelRecipeJson(recipe_info, serializedArray);
        return model_json;
    }
    ...
    formSerialToObject: function(formInputsArray) {
        var inputArrays = formInputsArray.map(function(inputObj) {
            return _.values(inputObj);
        }), inputObj = _(inputArrays).object();
        return inputObj;
    },
    remodelRecipeJson: function(formInfo, formInputsArray) {
