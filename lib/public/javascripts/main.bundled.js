...
app.ApprovalRiver = Backbone.View.extend({
    ...
    content: {
        setActiveAlerts: function() {
            ...
            console.log(current_filtered_set);
...
views.AA_BaseForm = Backbone.View.extend({
    ...
    initArticleTitleSearcher: function() {
        ...
        if (_.isArray(this.schema.assignees.selected)) {
...
views.Alert = Backbone.View.extend({
    ...
    bakeEventCreator: function() {
        ...
        this._time_pickers = event_creator_view.time_picker;
...
views.ShowAllRecipes = Backbone.View.extend({
    ...
    filter: function() {
        collections.po.alerts.filters.id.clearQuery();
    }
});
...
collections.init = {
    ...
    "approval-river": function() {
        ...
        var recipe_id_filter = PourOver.makeExactFilter("id", recipe_ids);
