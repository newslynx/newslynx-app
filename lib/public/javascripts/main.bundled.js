...
helpers.common = {
    ...
    bakeEventCreationForm: function(recipe_id, text, link, timestamp) {
        ...
        }).default_event), schema_with_selects = this.combineFormSchemaWithVals(schema, settings), 
    ...
    combineFormSchemaWithVals: function(schema_obj, settings_obj, recipeName) {
        return console.log("schema", schema_obj), console.log("settings", settings_obj), 
        console.log("next..."), schema_obj.name && (schema_obj.name.selected = recipeName), 
