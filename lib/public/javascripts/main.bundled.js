...
views.AA_BaseForm = Backbone.View.extend({
    ...
    formJsonToMarkup: {
        ...
        paragraph: function(fieldName, data) {
            var value = this.escapeQuotes(data.selected) || "", input_markup = '<textarea type="text" name="' + fieldName + '" class="' + fieldName + '" value="' + value + '" placeholder="' + (data.help && data.help.hint ? this.escapeQuotes(data.help.hint) : "") + '"/>';
            return input_markup;
        },
...
views.ArticleDetail = Backbone.View.extend({
    ...
    initialize: function() {
        ...
        views.po.article_detailed_events.setSort("timestamp_desc");
        var that = this;
...
collections.init = {
    articles: function() {
        ...
        this.po.sorts.timestamp_desc = timestamp_sort_desc;
