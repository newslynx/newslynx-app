...
collections.article_detailed_tweets = {
  "Collection": Backbone.Collection.extend({
    ...
    setUrl: function(articleId){
      this.url = 'api/_VERSION/events?sous_chefs=twitter-search-content-items-to-event&per_page=100&content_item_ids='+articleId
    },
...
views.ArticleDetail = Backbone.View.extend({
	...
	setDownloadButton: function(e){
		...
		function flattenObj(comparisonObj) {
			...
			var csv = []
			_.each(comparisonObj, function(groupMetrics, groupName){
