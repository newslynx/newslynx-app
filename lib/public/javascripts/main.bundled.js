...
helpers.common = {
    ...
    combineFormSchemaWithVals: function(schema_obj, settings_obj, recipeName) {
        return console.log(schema_obj, settings_obj, recipeName), schema_obj.name && (schema_obj.name.selected = recipeName), 
    ...
    render: function() {
        ...
        this.$submitMsg = this.$el.find(".submit-msg"), this.model.set("set_default_event", !1), 
        this;
    },
    save: function(e) {
        e.preventDefault();
    ...
    showHideDefaults: function() {
        ...
        open ? (this.$defautEventsBtn.html("Enabled").attr("data-status", "open"), this.$defaultEvents.slideDown(slide_duration, "easeOutQuint")) : (this.$defautEventsBtn.html("Disabled").attr("data-status", "closed"), 
