...
views.ArticleDetail = Backbone.View.extend({
	...
	setDownloadButton: function(e){
		...
		// Comparisons csv
		csvs[timestamp+'_article_'+this.model.id+'_comparisons'] = flattenObj(collections.article_comparisons.instance.toJSON()).map(addArticleMetrics(model_json.metrics))
		...
		models.exports.fetch({data: {content_item_ids: this.model.id}})
			.then(function(){

				console.log(models.export_data.toJSON())
