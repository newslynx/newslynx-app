...
views.ArticleSummaryRow = Backbone.View.extend({
	...
	calcSize: function(metric, val, max, group){
		/** Metric options: per_97_5, per75, median, per25, per2_5, per5, per95, mean **/
		group = group || this.comparison_marker_group;
		...
		var this_metrics_info = _.findWhere(temp_list, {metric: metric}),
				max,
				scale,
				val_percent;
