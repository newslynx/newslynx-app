...
views.AA_BaseForm = Backbone.View.extend({
    ...
    validate: function(requiredKeys, cb) {
        ...
        var existing_keys = _.keys(event_data), existing_vals = _.values(event_data), msg, missing_keys = [];
        ...
        if (missing_keys.length > 0) {
            msg = "You didn't include information for the required fields: " + missing_keys.join(", ") + ".";
...
views.EventCreator = views.AA_BaseForm.extend({
    ...
    createEvent: function(e) {
        ...
        var required_keys = [ "timestamp", "link", "assignees", "title", "what_happened", "significance", "impact_tags" ];
