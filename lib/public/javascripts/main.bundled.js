...
views.ArticleSummaryRow = Backbone.View.extend({
    ...
    initialize: function() {
        console.log("init");
        var redrawMarker_throttled = _.throttle(this.redrawMarker, 200);
        this.listenTo(this.model, "change:destroy", this.destroy);
        this.listenTo(this.model, "redrawMarker", redrawMarker_throttled);
    },
    render: function() {
    ...
    redrawMarker: function() {
        ...
        var that = this;
        var markers = this.bullet_markers.transition().duration(300).style("left", function(d) {
