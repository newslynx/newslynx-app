...
app.Articles = Backbone.View.extend({
	...
	render: function(){
		console.log(helpers.templates.articles)
	...
	setDownloadMultipleBtn: function(e){
		...
		var file_name = helpers.templates.articles.toUserTimezone( new Date() ).format('YYYY-MM-DDTHH-mm') + '-newslynx-export-' + collections.article_comparisons.instance.getHashList('-')
		console.log(file_name)
		console.log(this.$downloadMultiple)
		this.$downloadMultiple.attr('download', file_name)
		console.log(this.$downloadMultiple.attr('download'))
	}
