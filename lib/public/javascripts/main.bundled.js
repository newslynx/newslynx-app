...
helpers.common = {
    ...
    lazyLoadAlerts: function() {
        var $content = $(this), content_scrollHeight = $content[0].scrollHeight, content_scrollTop = $content.scrollTop(), content_outerHeight = $content.outerHeight(), at_bottom = content_scrollHeight - content_scrollTop == content_outerHeight, active_alerts_count = collections.active_alerts.instance.length, pending_alerts_count = collections.active_alerts.instance.metadata("active_recipe_id_pending"), we_dont_have_all_the_models = pending_alerts_count > active_alerts_count, active_recipe_id = (collections.active_alerts.instance.metadata("min_timestamp"), 
