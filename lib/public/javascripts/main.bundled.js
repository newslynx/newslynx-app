...
views.ArticleDetail = Backbone.View.extend({
    ...
    initialize: function() {
        ...
        this.eventsDataForST = _.map(events_data, function(eventData) {
        ...
        this.spottedTail = spottedTail().x(function(d) {
            ...
            return user_timezone_date;
        }).timezoneOffset(parseFloat(pageData.orgInfo.timezone)).y(function(d) {
            return +d.count;
        }).legend(this.legend).eventSchema(pageData.impactCategoriesInfo).events(this.eventsDataForST).interpolate("step-after").onBrush(this.filterEventsByDateRange_throttled);
    },
    render: function() {
