	...
	render: function(){
		...
		_tweets.append('div')
			...
			.html(function(d){
				...
				var html_without_script = d.meta.embed.replace('<script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>', '');
...
views.Tag = views.AA_BaseTag.extend({
	...
	styleLayout: function(){
		...
		console.log(set_bg_color, this.hexToRgbStr(set_bg_color), computed_bg)
