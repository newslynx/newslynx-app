...
helpers.common = {
    ...
    river: {
        bake: function(detailModel) {
            ...
            return console.log(detailModel), item_view = new views.RiverItem({
                model: detailModel
    ...
    drawer: {
        ...
        add: function(mode, uids) {
            app.helpers.drawer.setModeOnly(mode), console.log(uids, this.listUid), uids && collections.drawer_items.instance.setBoolByIds("viewing", this.listUid, uids, !1), 
        ...
        loadAllAlerts: function() {
            var section_mode = models.section_mode.get("mode");
    ...
    setHash: function() {
        if (console.log("before", this.modalOpen), !this.modalOpen) {
    ...
    Router: Backbone.Router.extend({
        ...
        loadAllInSection: function(mode) {
            app.helpers.drawer.setModeOnly(mode), app.helpers.drawer.loadAllAlerts.call(app.instance);
        },
        set: {
    ...
    helpers: {
        diffUids: function(mode, newUids) {
            ...
            return previous_uids || (previous_uids = app.helpers.drawer.getAllUids.call(app.instance)), 
