...
helpers.common = {
    ...
    formJsonToMarkup: {
        ...
        checkbox: function(source, prettyName, data) {
            ...
            if (_.contains(banished_keys, prettyName)) return "";
            {
                var markup;
                _.uniqueId(source);
            }
    ...
    saveModal: function(e) {
        this.toggleModal(e);
        var model_json = views.helpers.sanitizeRecipeJson(this.model.toJSON());
    ...
    sanitizeRecipeJson: function(modelJson) {
        return modelJson.name = modelJson.settings.name, delete modelJson.settings.name, 
        delete modelJson.viewing, delete modelJson.enabled, modelJson;
    }
}, routing = {
