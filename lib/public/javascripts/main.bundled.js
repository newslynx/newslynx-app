...
app.Articles = Backbone.View.extend({
	...
	setDownloadMultipleBtn: function(e){
		...
		e.preventDefault()
		e.stopPropagation()
		var $downloadMultiple = this.$downloadMultiple;

		// Set the `download` attribute
		var file_name = helpers.templates.articles.toUserTimezone( new Date() ).format('YYYY-MM-DDTHH-mm') + '-newslynx-export-' + collections.article_comparisons.instance.getHash('-')
		$downloadMultiple.attr('download', file_name)
	}
