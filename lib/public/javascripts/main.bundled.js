...
app.Articles = Backbone.View.extend({
    ...
    sectionMode: {
        ...
        detail: function() {
            var that = this;
            this.$content.html("");
            this.detail.loadModel.call(this, function(model) {
    ...
    detail: {
        ...
        loadModel: function(cb) {
            var that = this, detail_model, detail_model_id, fetch_options = {
                data: {},
                processData: true,
                success: function(collection, response, options) {
            ...
            if (detail_model_id) {
                ...
                console.log(collections.articles_detailed.instance.models, detail_model_id);
                if (!detail_model) {
