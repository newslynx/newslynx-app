...
helpers.common = {
    ...
    Router: Backbone.Router.extend({
        ...
        readPage: function(mode, uids) {
            mode = mode.replace(/\//g, ""), "my-recipes" != mode && "all" != uids ? (uids = routing.helpers.diffUids.call(this, mode, uids), 
            ...
            uids.exiting || uids.exiting || app.helpers.drawer.setModeOnly(mode)) : (app.helpers.drawer.setModeOnly(mode), 
            app.helpers.drawer.loadAllAlerts.call(app.instance));
        },
        set: {
