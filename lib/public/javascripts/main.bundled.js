...
helpers.common = {
    ...
    meta: function(prop, value) {
        return void 0 === value ? this._meta[prop] : void (this._meta[prop] = value);
    }
}, helpers.templates = {
    ...
    river: {
        ...
        destroy: function(detailModel) {
            ...
            viewing_all || detailModel.set("destroy", !0);
        },
    ...
    itemDetail: {
        go: function(listItemModel) {
            var destination, action, is_new = listItemModel.get("viewing"), uid = listItemModel.get(this.listUid), pending = listItemModel.get("pending");
        ...
        fetch: function(itemUid, action, cb, pending) {
            ...
            if (console.log(mode), loaded_matches.length && "my-recipes" != mode || "my-recipes" == mode && loaded_matches.length == pending) cb.call(this, loaded_matches); else if ("remove" != action) {
        ...
        add: function(itemData) {
            collections.detail_items.instance.set(itemData), console.log("here");
        },
    ...
    articles: function() {
        ...
        this.detail_items.instance.sort = "datetime";
    },
    "approval-river": function() {
