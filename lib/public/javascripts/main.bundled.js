...
app.ApprovalRiver = Backbone.View.extend({
    ...
    sectionMode: {
        ...
        "my-recipes": function() {
            var $drawer = this.$drawer, $drawerPointersContainer = $drawer.find("#drawer-pointers-container"), $content = this.$content;
            $drawer.attr("data-mode", "my-recipes");
            var has_recipes = this.accountRecipes.length;
            ...
            $drawerPointersContainer.html(show_all_markup);
        },
        create: function() {}
    },
    render: function() {
...
views.ShowAllRecipes = Backbone.View.extend({
    ...
    render: function(hasRecipes) {
        var tag_markup = templates.showAllRecipesFactory({
    ...
    styleLayout: function() {
        var active_recipe = app.instance.viewing_recipe_id, current_mode_selection_state = active_recipe == "all";
...
routing = {
    Router: Backbone.Router.extend({
        ...
        loadAllInSection: function(mode) {
            app.instance.viewing_recipe_id = "all";
            this.setModeOnly(mode);
        },
...
collections.init = {
    articles: function() {
        ...
        function makePourOverSortByLength(key) {
            return PourOver.Sort.extend({
                attr: "uqbar",
                fn: function(a, b) {
        ...
        var timestampSortDesc = makePourOverSort("timestamp"), pageviewsSortDesc = makePourOverSort("pageviews"), twitterMentionsSortDesc = makePourOverSort("twitter"), facebookLikesSortDesc = makePourOverSort("facebook"), avgTimeOnPageSortDesc = makePourOverSort("avg_time_on_page"), internalSortDesc = makePourOverSort("internal"), externalSortDesc = makePourOverSort("external");
        var subjectTagsSortDesc = makePourOverSortByLength("subject_tags"), impactTagsSortDesc = makePourOverSortByLength("impact_tags");
