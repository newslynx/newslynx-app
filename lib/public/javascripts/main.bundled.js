...
helpers.common = {
    ...
    itemDetail: {
        go: function(listItemModel) {
            var destination, action, is_new = listItemModel.get("viewing"), id = listItemModel.get(this.listId), pending = 9, min_timestamp = collections.detail_items.instance.meta("timestamp");
        ...
        fetch: function(itemId, action, cb, pending) {
