app.ApprovalRiver = Backbone.View.extend({
	...
	bake: function(){
		...
		collections.drawer_items.instance.each(function(recipe){
			...
			// recipe.listenTo(models.all_alerts.instance, 'change:viewing', recipe_view.updateViewingRadio)
		}, this);
	...
	river: {
		...
		loadAllAlerts: function(loadAllModel){
			...
			if (load_all){
				...
				collections.detail_items.instance.set(collections.all_alerts.instance.models); 
