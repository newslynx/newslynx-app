app.ApprovalRiver = Backbone.View.extend({
	...
	initialize: function(){
		...
		// Store how many total alerts we have pending for all alerts
		...
		// When a recipe item has `viewing` set to true
	...
	sectionMode: {
		...
		'my-recipes': function(){
			...
			var $drawer = this.$drawer,
					$drawerPointersContainer = $drawer.find('#drawer-pointers-container'),
			...
			// Save it so we might modify its selected state on selection
