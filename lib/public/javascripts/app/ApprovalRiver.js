		...
		setActiveAlertsPerRecipe: function(recipeId){
			...
			var fetch_options = {
				...
				success: function(collection, response, options){
					...
					// }
					// Add all of this collection's models to the active set
					...
					// Kill the content loading state
					// that.setLoading(that.$content, 'false');
			...
			// 	pending_alerts_count = collections.recipes.instance.findWhere({id: recipeId}).get('event_count');
