app.helpers = {
	...
	itemDetail: {
		...
		fetch: function(itemUid, action, cb, pending, minTimestamp){
			...
			// var loaded_matches = collections.all_detail_items.instance.where({recipe_id: itemUid}); 
			var loaded_matches = collections.all_detail_items.instance.filterAlerts(app.instance.detailUid, itemUid);
