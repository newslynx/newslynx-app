...
// 		// Listen for changes in the article selection and update the drawer with appropriate article summaries
// 		// Does this by filtering `collections.article_summaries.instance` and setting `collection.active_article_summaries.instance`
