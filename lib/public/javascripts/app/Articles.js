app.Articles = Backbone.View.extend({
	...
	divisionSwitcher: {
		...
		updateHash: function(entering_mode, new_uid){
			...
			var new_uids = new_uid || models.section_mode.get('previous-uids') || ''; // Remember prior selection, or passed in selection
			...
			models.section_mode.set('previous-uids', current_uids);
			return this;
		}
	},
