app.Articles = Backbone.View.extend({
	...
	sectionMode: {
		...
		compare: function(){
			...
			var compare_models = this.comparison.loadRows(staged_article_comparison_models, this.saveHash); // Analagous to this.detail.loadPage excempt doesn't require fetching because article summaries are already loaded
	...
	comparison: {
		...
		loadRows: function(stagedArticleComparisonModels, saveHash){
			...
			console.log(stagedArticleComparisonModels)
