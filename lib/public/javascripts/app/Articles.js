app.Articles = Backbone.View.extend({
	...
	initialize: function(){
		...
		// Listen for changes in facet counts and show hide all tag controls
		this.listenTo(models.content_item_filters, 'filter', this.fetchByParameters);
	...
	fetchByParameters: function(){
		var params = models.content_item_filters.toJSON();
		...
		collections.article_summaries.instance.fetch({data: params})
	...
	setLoadMoreButton: function(){
		...
		// console.log('here')
		// var article_summaries_collection = collections.article_summaries.instance,
		// 		pagination_info = article_summaries_collection.metadata('pagination'),
		// 		total_length = article_summaries_collection.metadata('total'),
		// 		numb_of_matches = article_summaries_collection.length,
		// 		page_size = pagination_info.per_page,
		...
		// var diff = numb_of_matches - page_size,
		// 		$loadMore = $('<button class="load-more"></button>'),
		// 		load_more_str = 'Load ' + page_size + ' more...',
 	// 			article_count_str;

		// if (diff > 0) {
		// 	article_count_str = 'Showing ' + page_size + ' of ' + numb_of_matches + ' articles.';
		...
		// } else {
		// 	article_count_str = 'Showing ' + numb_of_matches + ' matching articles.';
		// }

		// $articleCount.html(article_count_str);

		// if (diff > 0) {
		// 	$articleCount.html('Showing ' + page_size + ' of ' + current_length + ' articles.').parent().removeClass('disabled').prop('disabled', false);
		// } else if (page_size >= total_length){
		// 	$articleCount.html('Loaded all ' + total_length +  ' articles.').parent().addClass('disabled').prop('disabled', true);
		// } else {
		// 	$articleCount.html('Showing ' + current_length +  ' matching articles.').parent().addClass('disabled').prop('disabled', true);
		// }
